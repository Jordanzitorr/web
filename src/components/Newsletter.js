        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 gap-8 text-center md:text-left md:grid-cols-2 md:gap-16 md:place-items-center">
          <article>
            ...
            <p className="text-slate-100">
              Receive the latest updates. Keep on touch
            </p>
          </article>
          <article>
            <form>
              ...
              />
              <button type="submit" className="bg-white py-2 px-8 rounded shadow text-slate-800 tracking-wide hover:opacity-75 transition-all duration-200 w-full md:w-auto">Subscribe</button>
